...
var require_tailwind_config = __commonJS({
  "src/tailwind.config.js"(exports, module) {
    module.exports = {
      content: [],
      theme: {
        screens: {
        ...
        extend: {
          ...
          colors: {
            ...
            background: {
              ...
              primary: "#ffffff",
              // bg-background-primary, text-background-primary, border-background-primary,
              secondary: "#eeeeee",
              tertiary: "#666666",
              alternative: "#000000",
              success: "#ecfdf3",
...
var tailwind_config = require_tailwind_config();

export { tailwind_config as default };
